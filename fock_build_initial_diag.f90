...
call find_threshold(nss,schwss,orderss,shthresh,nsigss)
end if
...
call find_threshold(nsp,schwsp,ordersp,shthresh,nsigsp)
end if
...
call find_threshold(nsd,schwsd,ordersd,shthresh,nsigsd)
end if
...
call find_threshold(nsl,schwsl,ordersl,shthresh,nsigsl)
end if
...
call find_threshold(npp,schwpp,orderpp,shthresh,nsigpp)
end if
...
call find_threshold(npd,schwpd,orderpd,shthresh,nsigpd)
end if
...
call find_threshold(npl,schwpl,orderpl,shthresh,nsigpl)
end if
...
call find_threshold(ndd,schwdd,orderdd,shthresh,nsigdd)
end if
...
call find_threshold(ndl,schwdl,orderdl,shthresh,nsigdl)
end if
...
call find_threshold(nll,schwll,orderll,shthresh,nsigll)
end if

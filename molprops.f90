...
integer(i4b) :: natom, nb, nb2, nocc, ncore       ! Total number of atoms, basis funcs, bfunc pairs, occupied orbs, core orbs
...
integer(i4b), allocatable :: s_ssprs(:,:) ! List containing shell pair numbers for given s shell
...
integer(i4b), allocatable :: nksqu(:)    ! Number of K^2 primitive pairs for a shell pair
...
real(dp), allocatable :: ddabl(:,:)      ! djkla * djklb
...
integer(i4b) :: nsigss, nsigsp, nsigsd, nsigsl, nsigpp, nsigpd, nsigpl, nsigdd, nsigdl, nsigll
...
integer(i4b) :: naaaa,naaab,naabb,nabab,naabc,nabcd_d
integer(i4b) :: maxaaaa,maxaaab,maxaabb,maxabab,maxaabc,maxabcd_d
integer(i8b) :: nb4,maxabcd, nabcd
integer(i4b), allocatable :: aonaaaa(:)
integer(i4b), allocatable :: aonaaab(:)
integer(i4b), allocatable :: aonaabb(:)
integer(i4b), allocatable :: aonabab(:)
integer(i4b), allocatable :: aonaabc(:,:)
integer(i4b), allocatable :: aonabcd(:,:)
integer(i4b), allocatable :: aonabcd_d(:,:)
real(dp), parameter :: intthresh=1.d-11
!real(dp), parameter :: shthresh=intthresh/10._dp
real(dp), parameter :: shthresh=intthresh
real(dp), parameter :: schwthresh=1.d-11
real(dp), allocatable :: i2eaaaa(:)
real(dp), allocatable :: i2eaabb(:)
real(dp), allocatable :: i2eabab(:)
real(dp), allocatable :: i2eaabc(:)
real(dp), allocatable :: i2eabcd(:)
real(dp), allocatable :: i2eabcd_d(:)

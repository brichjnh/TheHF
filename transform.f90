...
integer(i4b) :: j,k,l,mu,nu,lbd,sig, ia,ja,ka,la,allocok
integer(i8b) :: i
...
do i=1,naaaa
  ia=aonaaaa(i)
  i2e4i(ia,ia,ia,ia)=i2eaaaa(i)
end do

do i=1,naabb
  ia=revind2(1,aonaabb(i)) ; ka=revind2(2,aonaabb(i))
  i2e4i(ia,ia,ka,ka)=i2eaabb(i)
  i2e4i(ka,ka,ia,ia)=i2eaabb(i)
end do

do i=1,naabc
  ia=aonaabc(1,i)
  ka=revind2(1,aonaabc(2,i)) ; la=revind2(2,aonaabc(2,i))
  i2e4i(ia,ia,ka,la)=i2eaabc(i)
  i2e4i(ia,ia,la,ka)=i2eaabc(i)
  i2e4i(ka,la,ia,ia)=i2eaabc(i)
  i2e4i(la,ka,ia,ia)=i2eaabc(i)
end do
do i=1,nabab
  ia=revind2(1,aonabab(i)) ; ja=revind2(2,aonabab(i))
  i2e4i(ia,ja,ia,ja)=i2eabab(i)
  i2e4i(ia,ja,ja,ia)=i2eabab(i)
  i2e4i(ja,ia,ia,ja)=i2eabab(i)
  i2e4i(ja,ia,ja,ia)=i2eabab(i)
end do
  
do i=1,nabcd_d
  ia=revind2(1,aonabcd_d(1,i)) ; ja=revind2(2,aonabcd_d(1,i))
  ka=revind2(1,aonabcd_d(2,i)) ; la=revind2(2,aonabcd_d(2,i))
  i2e4i(ia,ja,ka,la) = i2eabcd_d(i)
  i2e4i(ia,ja,la,ka) = i2eabcd_d(i)
  i2e4i(ja,ia,ka,la) = i2eabcd_d(i)
  i2e4i(ja,ia,la,ka) = i2eabcd_d(i)
  i2e4i(ka,la,ia,ja) = i2eabcd_d(i)
  i2e4i(la,ka,ia,ja) = i2eabcd_d(i)
  i2e4i(ka,la,ja,ia) = i2eabcd_d(i)
  i2e4i(la,ka,ja,ia) = i2eabcd_d(i)
end do
do i=1,nabcd
  ia=revind2(1,aonabcd(1,i)) ; ja=revind2(2,aonabcd(1,i))
  ka=revind2(1,aonabcd(2,i)) ; la=revind2(2,aonabcd(2,i))
  i2e4i(ia,ja,ka,la) = i2eabcd(i)
  i2e4i(ia,ja,la,ka) = i2eabcd(i)
  i2e4i(ja,ia,ka,la) = i2eabcd(i)
  i2e4i(ja,ia,la,ka) = i2eabcd(i)
  i2e4i(ka,la,ia,ja) = i2eabcd(i)
  i2e4i(la,ka,ia,ja) = i2eabcd(i)
  i2e4i(ka,la,ja,ia) = i2eabcd(i)
  i2e4i(la,ka,ja,ia) = i2eabcd(i)
end do


! Once we have i2e4i, we no longer need the 1-d array of integrals
deallocate(i2eaaaa,i2eaabb,i2eabab,i2eaabc,i2eabcd_d,i2eabcd)
deallocate(aonaaaa,aonaabb,aonabab,aonaabc,aonabcd_d,aonabcd)

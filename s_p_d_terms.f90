...
integer(i4b) :: ab, cd, zzab, zzcd, m, lp1, l, lm1, jj, jrec
...
integer(i4b) :: ab, cd, zzab, zzcd, m, lp1, l, lm1
...
integer(i4b) :: ab, cd, za, zc, zzab, zzcd, m
...
integer(i4b) :: ab, cd, za, zc, zzab, zzcd, m, jrec
...
do zzab=1,nksqu(ab)
    ...
    do zzcd=1,nksqu(cd)
        ...
        do l=1,10
          do jp1=5,10
            j=min1b(2,jp1) ! This will range from 2 to 4
            jrec=min1b(1,jp1) ! This will range from 2 to 4
            lp1=plus1(jrec,l) ! This will from 11 to 56
            jm1=minus1s(jrec,j) ! This will be either 0 or 1
            lm1=minus1(jrec,l) ! And this will go from 2 to 20
            oset(jp1,l)=-delv(jrec)*oset(j,l)-qop*oset(j,lp1)
